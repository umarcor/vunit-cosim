...
void testCinterface(
  ...
  int32_t* vec_int;
  fatptrToArray(v_vec_int, (void**)&vec_int, &len);
  assert(vec_int[0] == 11);
  assert(vec_int[1] == 22);
  assert(vec_int[2] == 33);
  assert(vec_int[3] == 44);
  ...
  double* vec_real;
  fatptrToArray(v_vec_real, (void**)&vec_real, &len);
  ...
  bool* vec_bool;
  fatptrToArray(v_vec_bool, (void**)&vec_bool, &len);
  assert(vec_bool[0] == 0);
  assert(vec_bool[1] == 1);
  assert(vec_bool[2] == 1);
  assert(vec_bool[3] == 0);
  ...
  bool* vec_bit;
  fatptrToArray(v_vec_bit, (void**)&vec_bit, &len);
  assert(vec_bit[0] == 1);
  assert(vec_bit[1] == 0);
  assert(vec_bit[2] == 1);
  assert(vec_bit[3] == 0);
  ...
  int64_t* vec_phy;
  fatptrToArray(v_vec_phy, (void**)&vec_phy, &len);
  ...
  rec_t* vec_rec;
  fatptrToArray(v_vec_rec, (void**)&vec_rec, &len);
  ...
  uint8_t* vec_enum;
  fatptrToArray(v_vec_enum, (void**)&vec_enum, &len);
  ...
  fatptrTo2DArray(v_2vec_real, (void**)&vec2_real_base, &len, &num);
  double (*vec2_real)[len] = (double(*)[len])vec2_real_base;
